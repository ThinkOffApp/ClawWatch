...
object SecurePrefs {
    private const val TAG = "PhoneSecurePrefs"
    private const val LEGACY_PREFS_NAME = "phone_prefs"
    private const val SECURE_PREFS_NAME = "phone_secure_prefs"
    ...
    fun phone(context: Context): SharedPreferences {
        val secure = try {
    ...
    private fun migrateLegacyIfPresent(context: Context, secure: SharedPreferences) {
        ...
        Log.i(TAG, "Migrated legacy phone prefs to encrypted storage")
    }
}
